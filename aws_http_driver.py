...
def describe_auto_scale_groups():
  method = 'GET'
  endpoint = 'https://autoscaling.us-west-2.amazonaws.com'
  parameters = {
...
def get_auto_scale_groups():
  root = describe_auto_scale_groups()
  ns = namespace(root)
...
def build_canonical_request(method, endpoint, parameters):
  ...
  return _build_canonical_request(method, endpoint, host, region, service, parameters)

def _build_canonical_request(method, endpoint, host, region, service, parameters):
